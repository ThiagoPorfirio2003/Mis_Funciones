...
int main(void) {
	...
	Passenger hardcodeado[]={
			{1,"Pedra", "Rácedo", 78030, "ADF231ASD", 3, 1, 0},
			{3,"Thiago", "Porfirio", 102003, "CVX124FDA", 2, 0, 0},
			{2,"Patricio", "Fernandez", 52000, "ASD536ADF", 3, 0, 0},
			{4,"Juana", "Rácedo", 32000, "ABC456CVB", 2, 1, 0},
			{0,"Esteban", "Águirre", 15000, "FDS346DAF", 3, 1, 0},
	};
			...
			switch(opcionMenu)
			{
				...
				case 2:
					if(banderaOpcionDos ==1)
					{
						...
						{
							printf("\n\nNo se elimino el usuario, debido a un error o inexistencia");
						}
					}
					else
					{
