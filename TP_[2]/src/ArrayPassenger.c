...
int Passenger_SwapPorTipoPasajeroAscendente(Passenger* primerPasajero, Passenger* segundoPasajero)
{
	int retorno;
	int restaEntreTipos;
...
int Passenger_SwapPorTipoPasajeroDescendente(Passenger* primerPasajero, Passenger* segundoPasajero)
{
	int retorno;
	int restaEntreTipos;
...
int Passenger_SwapPassengerPorApellidoYTipoPasajero(Passenger* primerPasajero, Passenger* segundoPasajero, int (*pFuncionSwapeoApellido)(Passenger*, Passenger*), int (*pFuncionSwapeoTipoPasajero)(Passenger*, Passenger*))
{
	int retorno;
...
int Passenger_SwapPorCodigoVueloAscendente(Passenger* primerPasajero, Passenger* segundoPasajero)
{
	int estadoComparacion;
...
int Passenger_SwapPorEstadoVueloAscendente(Passenger* primerPasajero, Passenger* segundoPasajero)
{
	int retorno;
	int restaEntreTipos;
...
int Passenger_SwapPorCodigoVueloDescendente(Passenger* primerPasajero, Passenger* segundoPasajero)
{
	int estadoComparacion;
...
int Passenger_SwapPorEstadoVueloDescendente(Passenger* primerPasajero, Passenger* segundoPasajero)
{
	int retorno;
	int restaEntreTipos;
		...
		do{
			...
			for(int i=0;i<limiteDecremental;i++)
			{
				...
				*/
				...
				//estadoSwapAscendente = Passenger_SwapPassengerPorCodigoVueloYEstadoVuelo(&list[i], &list[i+1], pFuncionSwapCodigoVuelo, pFuncionSwapEstadoVuelo);

				/*
				if(list[i].isEmpty == 0 && list[i+1].isEmpty == 0)
				{
					estadoSwapAscendente = Passenger_SwapPassengerPorApellidoYTipoPasajero(&list[i], &list[i+1], pFuncionSwapCodigoVuelo, pFuncionSwapEstadoVuelo);
					if(estadoSwapAscendente != 2)
					{
						if(estadoSwapAscendente == 1)
						{
