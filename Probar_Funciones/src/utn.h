...
int pruebaGets(char* direccionCadenaCaracteres, int longitud);
...
/// @return int: Un 0 en caso de que se cumplan todas las direcciones o 1 si no lo hace
int utn_transfomarAMayusculaPrimerLetraDeCadaPalabra(char* direccionPalabra);
...
int getInt(int* direccionInt, int cantidadDeCifras);
