...
int memoria_ReSizeFloat(float** punteroAPunteroFloatDinamico ,int nuevaLongitud)
{
	...
	if(punteroAPunteroFloatDinamico!=NULL && nuevaLongitud>0 && !memoria_NewInt(&punteroAFloatAuxiliar))
	{
...
int memoria_ReSizeChar(char** punteroAPunteroCharDinamico ,int nuevaLongitud)
{
	...
	if(punteroAPunteroCharDinamico!=NULL && nuevaLongitud>0 && !memoria_NewInt(&punteroAFloatAuxiliar))
	{
