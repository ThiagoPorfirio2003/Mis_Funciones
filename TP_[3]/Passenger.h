...
/// @pre
/// @post
/// @return int: Nulo si no se pudo crear un nuevo pasajero, pero si se pudo devuelve el puntero a ese pasajero
Passenger* Passenger_new();

/// @brief Con esta funcion se crea un nuevo dato de tipo Passenger ademas de cargarle datos que se le son pasados por parametros
///
/// @pre
/// @post
/// @param idStr
...
/// @param statusFlight
/// @return int: Nulo si no se pudo crear un nuevo pasajero, o si alguno de los punteros son nulos, o si alguno de los datos no cumplen con sus requisitos.
